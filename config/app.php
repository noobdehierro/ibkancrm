...
return [
    ...
    'providers' => [
        ...
        LeanCommerce\Debtor\Providers\DebtorServiceProvider::class,
        LeanCommerce\Payment\Providers\PaymentServiceProvider::class,
        LeanCommerce\Agreement\Providers\AgreementServiceProvider::class,
        LeanCommerce\Unknown\Providers\UnknownServiceProvider::class,
        LeanCommerce\Map\Providers\MapServiceProvider::class,
        LeanCommerce\Clarification\Providers\ClarificationServiceProvider::class,
        LeanCommerce\Help\Providers\HelpServiceProvider::class,
        LeanCommerce\Recuperation\Providers\RecuperationServiceProvider::class,
        LeanCommerce\StatusNotification\Providers\StatusNotificationServiceProvider::class,
        LeanCommerce\StatusHistory\Providers\StatusHistoryServiceProvider::class,
    ],
